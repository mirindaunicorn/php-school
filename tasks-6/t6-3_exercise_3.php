...
$student1->studyTime(60);
$student2->studyTime(100);
$student3->studyTime(40);
$student4->studyTime(300);
$student5->studyTime(1000);

$studentsNew = [$student1, $student2, $student3, $student4, $student5];

foreach ($studentsNew as $student) {
